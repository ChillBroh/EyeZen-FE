...
const InfantQuizHome = () => {
  ...
  return (
    <div>
      <section
        className="bg-gradient-to-b from-indigo-200 from-1% via-white py-5 pr-12 pl-8 mb-8"
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center relative z-10">
          <div>
            ...
            <p className="text-lg text-gray-400 mb-8">
              We understand that your little one's eyes are their window to the
              world. As parents ourselves, we know the importance of ensuring
              your child's visual health from the very beginning. That's why
              we're here to guide you on a journey of care, knowledge, and
              nurturing for those precious little peepers.
            </p>
          </div>
          <div className="group">
            {/* Image */}
