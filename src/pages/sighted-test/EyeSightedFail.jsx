  ...
  return (
    <div className='h-screen flex flex-col lg:flex-row mt-8 lg:mt-0 items-center lg:justify-between lg:px-36 px-8'>
        <div className='flex flex-col items-center'>
            ...
            <h1 className='font-bold text-3xl lg:text-5xl text-[#CA3747] mb-4'>Your Vision is not Good!</h1>
            <h1 className='font-semibold text-3xl lg:text-3xl ] mb-4'>Channel a Ophthalmologist</h1>
