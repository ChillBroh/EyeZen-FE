...
const NearSighted = () => {
  ...
  const handleButtonClick = () => {
    ...
    const targetRoute = location.pathname === "/far-sighted" ? "/test-view" : content[2];
    ...
    <div className="lg:flex lg:items-center px-4 pt-12 lg:pt-0 lg:p-0 lg:h-screen lg:justify-between w-full">
      <div className="flex flex-col lg:flex-row items-center lg:justify-center h-screen">
        <div className="lg:px-24">
          <div className="flex">
            <h1 className="lg:text-5xl text-2xl font-extrabold">{content[0]}</h1>
        ...
        <div className="lg:bottom-0 lg:right-0 pt-8 lg:pt-0">
          <img className="lg:w-[700px] " src={nearSightedImg} alt="sighted-home" />
        </div>
      </div>
    </div>
  );
