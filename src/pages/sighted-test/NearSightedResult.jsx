...
const NearSightedResult = () => {
  ...
  const result = location.state && location.state.visionLevel ? location.state.visionLevel : null;
  ...
  return (
    <div className='h-screen flex flex-col lg:flex-row mt-8 lg:mt-0 items-center lg:justify-between lg:px-36 px-8'>
        <div className='flex flex-col items-center'>
            ...
            <h1 className='font-bold text-3xl lg:text-5xl text-[#004AAD] mb-4'>{result}</h1>
